...
public class App {
    public static void main(String[] args) throws Exception {
        ArrayList<cinderamata> cdm  = new ArrayList<>();
        ...
        while(true){
            ...
            if (Menu.equals("1")){
                ...
                if (ubah <= cdm.size()){
                    ...
                    cdm.get(ubah).namacdm = br.readLine();
                    System.out.println("Masukkan Jenis Baru : ");
                    cdm.get(ubah).jeniscdm = br.readLine();
                    System.out.println(" Masukkan Harga Baru :");
                    cdm.get(ubah).hargacdm = Integer.parseInt(br.readLine());
